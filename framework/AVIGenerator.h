...
#ifndef __AVIGENERATOR_H__
#define __AVIGENERATOR_H__
...
public:
	...
	CAVIGenerator(LPCTSTR sFileName, BITMAPINFOHEADER lpbih, DWORD dwRate);
	~CAVIGenerator();
	//@}
	...
	*/
	...
	BITMAPINFOHEADER GetBitmapHeader()							{	return m_bih;};
	...
	// recuperation de frame
#ifdef _AVIGENERATOR_USE_MFC
	void AviToCImageList(string filepathname, CImageList *imglist);
	BOOL CreateFromPackedDIBPointer(LPBYTE pDIB, int iFrame, CImageList *imglist);
#endif
