...
#ifndef __UNIFORMEXPORTTOGIF_H__
#define __UNIFORMEXPORTTOGIF_H__
...
#include "..\framework\AVIGenerator.h"
...
class UniformExport : public UniformAbstract
{
public:
	UniformExport(wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize(816, 490), long style = wxTAB_TRAVERSAL, GLShaderRenderer *vShaderRenderer=0, ShaderView *vShaderView=0, UniformManager *vUniformManager=0);
	~UniformExport();
...
#endif //__UNIFORMEXPORTTOGIF_H__