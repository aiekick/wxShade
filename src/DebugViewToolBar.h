...
#ifndef __DEBUGVIEWTOOLBAR_H__
#define __DEBUGVIEWTOOLBAR_H__
...
#define DebugViewName "DebugViewToolBar"
class DebugViewToolBar : public wxPanel
{
public:
	DebugViewToolBar(DebugView *vDebugView, wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style);
...
protected:
	wxDECLARE_NO_COPY_CLASS(DebugViewToolBar);
	wxDECLARE_EVENT_TABLE();
};

#endif //__DEBUGVIEWTOOLBAR_H__